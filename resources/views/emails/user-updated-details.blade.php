                ...
                <table width="600" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        <td style="padding: 30px 40px;">
                            <h2 style="font-size: 20px; color: #2d3748; margin-top: 0;">Account Details Updated</h2>
                            <p style="color: #3d4852;">Hi {{ $user->name }},</p>
                            <p style="color: #3d4852;">An administrator has updated your account details. If you have any questions or concerns, please contact us.</p>

                            <p style="margin-top: 20px;">
                                <a href="mailto:{{ env('MAIL_FROM_ADDRESS') }}" style="display: inline-block; background-color: #3490dc; color: #ffffff; padding: 12px 25px; border-radius: 4px; text-decoration: none; font-weight: bold;">
                                    Contact Us
                                </a>
                            </p>
